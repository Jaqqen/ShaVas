    ...
    if (trans_m_options == 0):
        ...
        # stretch/compress BOTH corners - top/bottom
            ...
            if (top_or_bottom == [0, 1]):
                # print('=====> stretch/compress BOTH corners - UNEQUAL top <=====')
            ...
            # UNEQUAL bottom
                ...
                # print('=====> stretch/compress BOTH corners - UNEQUAL bottom <=====')
            ...
            # EQUAL top
                ...
                # print('=====> stretch/compress BOTH corners - EQUAL top <=====')
            ...
            # EQUAL bottom
                ...
                # print('=====> stretch/compress BOTH corners - EQUAL bottom <=====')
...
def createSamples(image_array, shape):
    ...
    try:
        if (shape != 2):
            frontend_samples_list.append(result_image_array)
...
def getSamplesListForJSON():
    ...
    for sample in frontend_samples_list:
